package top.whysu.front.fastdfs;
...
public class TrackerServerPool {
     ...
     */
    private static final String FASTDFS_CONFIG_PATH = "conf/resource.properties";
    ...
    private static synchronized GenericObjectPool<TrackerServer> getObjectPool(){
        logger.debug("FASTDFS_CONFIG_PATH: "+FASTDFS_CONFIG_PATH);
