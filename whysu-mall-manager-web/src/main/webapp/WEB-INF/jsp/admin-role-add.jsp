...
<div class="page-container">
    <form id="form-admin-role-add" class="form form-horizontal" method="post" action="">
        <div class="row cl">
...
<script type="text/javascript">
    ...
    $(function(){
        $("#checkAll").click(function(){ //全选/取消全选
            $(":checkbox").prop("checked",this.checked);// $(":checkbox") 选择器选取type="checkbox" 的 <input> 元素。
        });
