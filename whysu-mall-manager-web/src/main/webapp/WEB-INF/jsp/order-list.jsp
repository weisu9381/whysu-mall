...
<div>
    <nav class="breadcrumb">
        <i class="Hui-iconfont">&#xe67f;</i> 首页 &gt; 订单管理 &gt; 订单列表
    </nav>
...
<script type="text/javascript">
                ...
                { "data": "status",
                    render : function(data,type, row, meta) {
                        if(data==0){
                            ...
                            return "<span class=\"label label-warning radius td-status\">支付审核中</span>";
                        } else if(data==2){
    ...
    function order_del(obj,id){
        layer.confirm('确认要删除ID为\''+id+'\'的订单吗？',{icon:0},function(){
            var index = layer.load(3);
            $.ajax({
                type: 'POST',
                url: '${URL}/order/del/'+id,
                dataType: 'json',
                success: function(data){
                    layer.close(index);
                    if(data.success!=true){
