...
<div class="page-container">
    <form name="content-banner-edit" action="" method="post" class="form form-horizontal" id="content-banner-edit">
...
<script type="text/javascript">
    ...
    function chooseProduct(){
        layer_show("选择展示商品","content-choose-product",900,600);
    }
        ...
        $(function () {
            ...
            uploader.on( 'uploadSuccess', function( file,data ) {
                if(data.success==true){
                    ...
                    if(pic1==""){
                        images=data.httpUrl;
                        $("#picUrl").val(data.httpUrl);
                    }
                    if(pic1!=""&&pic2==""&&pic3==""){
                        images = images + ","+data.httpUrl;
                        $("#picUrl2").val(data.httpUrl);
                    }
                    if(pic1!=""&&pic2!=""&&pic3==""){
                        images = images + ","+data.httpUrl;
                        $("#picUrl3").val(data.httpUrl);
                    }
                }else{
