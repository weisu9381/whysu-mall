...
<article class="page-container">
    <form action="" method="" class="form form-horizontal" id="form-change-password">
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span>账号：</label>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="password" class="input-text" autocomplete="off" placeholder="请再次输入密码" name="passwordConfirm" id="passwordConfirm">
            </div>
        </div>
        <div class="row cl">
        ...
        submitHandler:function(form){
            ...
            $(form).ajaxSubmit({
                ...
                error:function(XMLHttpRequest) {
                    layer.close(index1);
                    layer.alert('修改密码失败! 错误码:'+XMLHttpRequest.status,{title: '错误信息',icon: 2});
                }
            });
        }
    });
