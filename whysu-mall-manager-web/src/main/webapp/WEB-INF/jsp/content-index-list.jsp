...
<div style="margin-left:200px;">
    <nav class="breadcrumb">
        <i class="Hui-iconfont">&#xe67f;</i> 首页 &gt; 商品管理 &gt; 首页板块内容管理 &gt; <span id="name"></span>
    </nav>
    <form id="form-search" class="page-container">
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                <a href="javascript:;" onclick="dataDel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
                <a class="btn btn-primary radius" onclick="content_product_add('添加展示内容','content-product-add')" href="javascript:;">
                    <i class="Hui-iconfont">&#xe600;</i> 添加展示内容
                </a>
...
<script type="text/javascript">
    ...
    /*产品-添加*/
    function content_product_add(title,url){
