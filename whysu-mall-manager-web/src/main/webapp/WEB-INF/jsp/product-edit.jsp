...
<div class="page-container">
    <form id="product-edit" name="product-edit" class="form form-horizontal" method="post">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input id="sellPoint" name="sellPoint" type="text" class="input-text"/>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品分类：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="cid" name="cid"  type="text" hidden class="input-text">
                <input id="cname" name="cname" type="text" onclick="chooseCategory()" readonly class="input-text" value="" placeholder="请点击选择按钮选择商品分类"  style="width:50%">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input id="price" name="price" type="text" placeholder="请输入正确金额" value="" class="input-text" style="width:50%">元
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>库存数量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="num" name="num" type="text" placeholder="0~99999" value="" class="input-text" style="width:50%">件
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>购买限制数量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="limitNum" name="limitNum" type="text" placeholder="0~9999" value="" class="input-text" style="width:50%">件
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $("#product-edit").validate({
        ...
        submitHandler: function (form) {
            ...
            editor.sync();
            $(form).ajaxSubmit({
                url: "${URL}/item/update/"+parent.getId(),
                type: "POST",
    ...
    var index = layer.load(3);//进入该页面显示“正在加载”的动画
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            KindEditor.html('#detail', data.result.detail);
        },
        error: function(XMLHttpRequest){
            layer.close(index);
            layer.alert('数据处理失败！错误码：'+ XMLHttpRequest.status,{title: '错误信息',icon: 2});
    ...
    var images = null;
    /*以下是webuploader官方的示例代码uploader.js，修改其中的文字描述等内容*/
    (function ($) {
