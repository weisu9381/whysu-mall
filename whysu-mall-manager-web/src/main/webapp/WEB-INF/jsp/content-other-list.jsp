...
<div style="margin-left:200px;">
    <nav class="breadcrumb">
        <i class="Hui-iconfont">&#xe67f;</i> 首页 &gt; 商品管理 &gt; 其它板块内容管理 &gt; <span id="name"></span>
    </nav>
    <form id="form-search" class="page-container">
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                ...
                <a class="btn btn-primary radius" onclick="product_add('添加展示内容','content-product-add')" href="javascript:;">
                    <i class="Hui-iconfont">&#xe600;</i> 添加展示商品
                </a>
                <a class="btn btn-secondary radius" href="javascript:location.replace(location.href);" title="刷新">
                    <i class="Hui-iconfont">&#xe68f;</i> 刷新
                </a>
            </span>
            <span class="r">最大容纳商品数：<strong id="num">2</strong></span>
        </div>
        <div class="mt-20">
        ...
        $('.table').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    "data": null,
                    render: function (data, type, row, meta) {
                        return "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"product_edit('内容编辑','content-product-edit')\" href=\"javascript:;\" title=\"编辑\"><i class=\"Hui-iconfont\">&#xe6df;</i></a> " +
        ...
        callback: {
            ...
            beforeClick: function(treeId, treeNode) {
                if (treeNode.isParent) {
                    ...
                    var url="${URL}/content/list/"+panelId;
