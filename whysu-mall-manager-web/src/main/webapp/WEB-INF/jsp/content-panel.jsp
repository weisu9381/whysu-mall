...
<nav class="breadcrumb">
    <i class="Hui-iconfont">&#xe67f;</i> 首页 &gt; 商城管理 &gt; 首页板块管理
</nav>
<table class="table">
    <tr>
            ...
            <div class="page-container">
                ...
                <div style="margin-left: 10px;margin-right: 10px" class="cl pd-5 bg-1 bk-gray">
                    <span class="l">
                        ...
                        <a class="btn btn-primary radius" onclick="content_panel_add('添加首页板块','content-panel-add',900,500)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加首页板块</a>
