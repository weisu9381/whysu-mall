...
import top.whysu.common.utils.ThreadPoolUtil;
import top.whysu.manager.annotation.SystemControllerLog;
import top.whysu.manager.annotation.SystemServiceLog;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(top.whysu.manager.annotation.SystemControllerLog)")
     ...
     * Service层切点,注解方式
     */
    @Pointcut("@annotation(top.whysu.manager.annotation.SystemServiceLog)")
